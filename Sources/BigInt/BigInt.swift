...
public struct BigInt: BinaryInteger, SignedNumeric, SignedInteger, CustomStringConvertible, LosslessStringConvertible, Hashable {
    ...
    internal var _isNegative: Bool {
        return words[words.endIndex - 1] > Int.max
    }
    ...
    public var bitWidth: Int { return words.count * MemoryLayout<UInt>.size * 8 }
    
    public var trailingZeroBitCount: Int { return words.first?.trailingZeroBitCount ?? 0 }
